...
4. Write just enough application code, implmenting an empty method (returning the correct type), and observe the test passing against an _incorrect_ return value.
